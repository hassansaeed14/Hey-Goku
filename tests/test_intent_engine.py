...
class IntentEngineTests(unittest.TestCase):
    def test_casual_conversation_does_not_misroute_to_currency(self):
    ...
    def test_plain_three_letter_words_are_not_treated_as_currency_codes(self):
        intent, confidence = detect_intent_with_confidence("how are you")
        self.assertEqual(intent, "general")
        self.assertGreaterEqual(confidence, 0.8)
